...
\newcommand{\doplnit}[1]{\emph{doplnit: #1}}
\newcommand{\TBDi}[1]{\textbf{TBD:} \emph{#1}}
\newcommand{\TBD}[1]{\textbf{TBD:} \emph{#1}}

%% Jednotlivé kapitoly
\include{text/1-zaklad}
\include{text/2-komunikace}
\include{text/3-konstrukce-modulu.tex}
\include{text/4-programovani}
\include{text/5-analyza-moznosti}
\include{text/6-srovnani}
\include{text/7-pilotni-provoz}
\include{text/8-uvedeni-do-provozu}
\include{text/9-dokumentace}
\include{text/10-hodnoceni}
